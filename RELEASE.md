...
This document describes how releases are created for DevFlow.

## Overview

DevFlow uses an automated release pipeline that ensures releases are only published after all builds succeed. This prevents version mismatches between documentation and actual releases.
...
After merging, check:
- [GitHub Actions](https://github.com/AndyMik90/devflow/actions) - ensure all workflows pass
- [Releases](https://github.com/AndyMik90/devflow/releases) - verify release was created
- [README](https://github.com/AndyMik90/devflow#download) - confirm version updated
