...
- Removed legacy path from devflow source detection
...
- fix: remove legacy path from devflow source detection (#148) by @Joris Slagter in f96c6301
...
- Default database path unified to ~/.devflow/memories for consistency
...
- fix: unify default database path to ~/.devflow/memories by @AndyMik90 in 684e3f9
...
- devflow: subtask-1-1 - Add projectPath prop to PreviewPanel and implement custom img component by @AndyMik90 in e6529e0
...
- Required GitHub setup flow after DevFlow initialization to ensure proper configuration
...
- Removed redundant devflow/specs directory structure
- Untracked .devflow directory to respect gitignore rules
...
- feat: add required GitHub setup flow after DevFlow initialization by @AndyMik90 in 03ccce5
- chore: remove redundant devflow/specs directory by @AndyMik90 in 64d5170
- chore: untrack .devflow directory (should be gitignored) by @AndyMik90 in 0710c13
...
- devflow: subtask-2-3 - Refine visual drop zone feedback to be more subtle by @AndyMik90 in 6cff442

- devflow: subtask-2-1 - Remove showFiles auto-expand on draft restore by @AndyMik90 in 12bf69d

- devflow: subtask-1-3 - Create an always-visible referenced files section by @AndyMik90 in 3818b46

- devflow: subtask-1-2 - Add drop zone wrapper around main modal content area by @AndyMik90 in 219b66d

- devflow: subtask-1-1 - Remove Reference Files toggle button by @AndyMik90 in 4e63e85
...
- feat: devflow: subtask-1-1 - Restructure SortableFeatureCard badge layout by @AndyMik90 in dc886dc
...
- Updated README to clarify DevFlow's role as an AI coding companion
...
- Removed .devflow and _bmad-output from git tracking (already in .gitignore)
...
- chore: Remove .devflow from tracking (already in .gitignore) by @AndyMik90 in 87f353c
...
- docs: Revise README.md to enhance clarity and focus on DevFlow's capabilities by @AndyMik90 in f9ef7ea
...
- Removed obsolete security configuration file (.devflow-security.json)
