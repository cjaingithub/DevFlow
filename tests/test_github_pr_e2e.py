...
def temp_github_dir(tmp_path):
    ...
    github_dir = tmp_path / ".devflow" / "github"
...
class TestBotDetectionE2E:
    ...
    def test_full_bot_detection_flow(self, tmp_path):
        ...
        with patch.object(BotDetector, "_get_bot_username", return_value="devflow[bot]"):
        ...
        bot_pr = {"author": {"login": "devflow[bot]"}}
        bot_commits = [{"author": {"login": "devflow[bot]"}, "oid": "bot_commit"}]
