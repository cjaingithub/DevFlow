...
# Create validator
spec_dir = Path("devflow/specs/001-feature")
...
python devflow/validate_spec.py --spec-dir devflow/specs/001-feature/ --auto-fix --checkpoint plan

# JSON output
python devflow/validate_spec.py --spec-dir devflow/specs/001-feature/ --checkpoint all --json
```
