...
Usage:
    python devflow/validate_spec.py --spec-dir devflow/specs/001-feature/ --checkpoint prereqs
    python devflow/validate_spec.py --spec-dir devflow/specs/001-feature/ --checkpoint context
    python devflow/validate_spec.py --spec-dir devflow/specs/001-feature/ --checkpoint spec
    python devflow/validate_spec.py --spec-dir devflow/specs/001-feature/ --checkpoint plan
    python devflow/validate_spec.py --spec-dir devflow/specs/001-feature/ --checkpoint all
"""
