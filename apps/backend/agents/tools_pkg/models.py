...
Defines tool name constants and configuration for devflow MCP tools.
...
- devflow tools: Custom build management tools
"""
...
# =============================================================================
# devflow MCP Tools (Custom build management)
# =============================================================================

# devflow MCP tool names (prefixed with mcp__devflow__)
TOOL_UPDATE_SUBTASK_STATUS = "mcp__devflow__update_subtask_status"
TOOL_GET_BUILD_PROGRESS = "mcp__devflow__get_build_progress"
TOOL_RECORD_DISCOVERY = "mcp__devflow__record_discovery"
TOOL_RECORD_GOTCHA = "mcp__devflow__record_gotcha"
TOOL_GET_SESSION_CONTEXT = "mcp__devflow__get_session_context"
TOOL_UPDATE_QA_STATUS = "mcp__devflow__update_qa_status"
...
AGENT_CONFIGS = {
    ...
    "planner": {
        ...
        "mcp_servers": ["context7", "graphiti", "devflow"],
    ...
    "qa_reviewer": {
        ...
        "tools": BASE_READ_TOOLS + BASE_WRITE_TOOLS + WEB_TOOLS,
        "mcp_servers": ["context7", "graphiti", "devflow", "browser"],
...
def get_required_mcp_servers(
    ...
    - Respects per-project MCP config overrides from .devflow/.env
    ...
    Args:
        ...
        mcp_config: Per-project MCP server toggles from .devflow/.env
    ...
    # Process removals (but never remove devflow)
    if remove_key in mcp_config:
        ...
        for server in removals:
            mapped = _map_mcp_server_name(server, custom_server_ids)
            if mapped and mapped != "devflow":  # devflow cannot be removed
