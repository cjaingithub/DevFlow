...
Central registry for creating and managing devflow MCP tools.
"""
...
def create_auto_claude_mcp_server(spec_dir: Path, project_dir: Path):
    """
    Create an MCP server with devflow custom tools.
    ...
    return create_sdk_mcp_server(name="devflow", version="1.0.0", tools=tools)
