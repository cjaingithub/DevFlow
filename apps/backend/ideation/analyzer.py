...
class ProjectAnalyzer:
    ...
    def gather_context(self) -> dict:
        ...
        # Get project index (from .devflow - the installed instance)
        project_index_path = self.project_dir / ".devflow" / "project_index.json"
        ...
        if self.include_roadmap:
            roadmap_path = (
                self.project_dir / ".devflow" / "roadmap" / "roadmap.json"
            )
            ...
            discovery_path = (
                self.project_dir / ".devflow" / "roadmap" / "roadmap_discovery.json"
            )
        ...
        if self.include_kanban:
            specs_dir = self.project_dir / ".devflow" / "specs"
            if specs_dir.exists():
