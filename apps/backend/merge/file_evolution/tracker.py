...
class FileEvolutionTracker:
    ...
    - File content snapshots in .devflow/baselines/
    ...
    def __init__(
        ...
        Args:
            ...
            storage_dir: Directory for evolution data (default: .devflow/)
        ...
        storage_dir = storage_dir or (self.project_dir / ".devflow")
