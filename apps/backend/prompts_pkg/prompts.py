...
def get_planner_prompt(spec_dir: Path) -> str:
    ...
    if not prompt_file.exists():
        raise FileNotFoundError(
            ...
            "Make sure the devflow/prompts/planner.md file exists."
        )
...
The project root is the parent of devflow/. Implement code in the project root, not in the spec directory.
...
def get_coding_prompt(spec_dir: Path) -> str:
    ...
    if not prompt_file.exists():
        raise FileNotFoundError(
            ...
            "Make sure the devflow/prompts/coder.md file exists."
        )
...
The project root is the parent of devflow/. All code goes in the project root, not in the spec directory.
...
def get_followup_planner_prompt(spec_dir: Path) -> str:
    ...
    if not prompt_file.exists():
        raise FileNotFoundError(
            ...
            "Make sure the devflow/prompts/followup_planner.md file exists."
        )
...
- Project root: Parent of devflow/ (where code should be implemented)
