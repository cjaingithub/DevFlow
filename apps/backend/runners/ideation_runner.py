...
Usage:
    python devflow/ideation_runner.py --project /path/to/project
    python devflow/ideation_runner.py --project /path/to/project --types low_hanging_fruit,high_value_features
    python devflow/ideation_runner.py --project /path/to/project --refresh
"""
...
def main():
    ...
    parser.add_argument(
        "--output",
        type=Path,
        help="Output directory for ideation files (default: project/devflow/ideation)",
    )
    parser.add_argument(
        "--types",
        type=str,
