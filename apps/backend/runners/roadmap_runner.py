...
Usage:
    python devflow/roadmap_runner.py --project /path/to/project
    python devflow/roadmap_runner.py --project /path/to/project --refresh
    python devflow/roadmap_runner.py --project /path/to/project --output roadmap.json
"""
...
def main():
    ...
    parser.add_argument(
        "--output",
        type=Path,
        help="Output directory for roadmap files (default: project/devflow/roadmap)",
    )
    parser.add_argument(
        "--model",
        type=str,
