...
Stored in .devflow/github/pr/ and .devflow/github/issues/
...
class PRReviewResult:
    ...
    async def save(self, github_dir: Path) -> None:
        """Save review result to .devflow/github/pr/ with file locking."""
...
class TriageResult:
    ...
    async def save(self, github_dir: Path) -> None:
        """Save triage result to .devflow/github/issues/ with file locking."""
...
class AutoFixState:
    ...
    async def save(self, github_dir: Path) -> None:
        """Save auto-fix state to .devflow/github/issues/ with file locking."""
        issues_dir = github_dir / "issues"
        issues_dir.mkdir(parents=True, exist_ok=True)
