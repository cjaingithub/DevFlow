...
class AuditLogger:
    ...
    Usage:
        audit = AuditLogger(log_dir=Path(".devflow/github/audit"))
    ...
    def __init__(
        ...
        Args:
            log_dir: Directory for audit logs (default: .devflow/github/audit)
        ...
        """
        self.log_dir = log_dir or Path(".devflow/github/audit")
