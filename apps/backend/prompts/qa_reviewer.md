...
# Note: qa_report.md and implementation_plan.json are in .devflow/specs/ (gitignored)
...
# Note: QA_FIX_REQUEST.md and implementation_plan.json are in .devflow/specs/ (gitignored)
# Do NOT commit them - the framework tracks QA status automatically
