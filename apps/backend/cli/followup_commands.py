...
def handle_followup_command(
    ...
    if not plan_file.exists():
        ...
        content = [
            ...
            "",
            highlight(f"  python devflow/run.py --spec {spec_dir.name}"),
            "",
    ...
    try:
        ...
        if success_result:
            ...
            content = [
                ...
                f"  python devflow/run.py --spec {spec_dir.name}",
            ]
            print(box(content, width=70, style="heavy"))
        else:
        ...
        print(f"To retry: python devflow/run.py --spec {spec_dir.name} --followup")
        sys.exit(0)
    except Exception as e:
        print()
