...
def _generate_and_save_commit_message(project_dir: Path, spec_name: str) -> None:
    ...
    try:
        ...
        if commit_message:
            ...
            spec_dir = project_dir / ".devflow" / "specs" / spec_name
...
def handle_list_worktrees_command(project_dir: Path) -> None:
    ...
    if not worktrees:
        ...
        print("-" * 70)
        print()
        print("  To merge:   python devflow/run.py --spec <name> --merge")
        print("  To review:  python devflow/run.py --spec <name> --review")
        print("  To discard: python devflow/run.py --spec <name> --discard")
        print()
        print(
            "  To cleanup all worktrees: python devflow/run.py --cleanup-worktrees"
        )
    print()
