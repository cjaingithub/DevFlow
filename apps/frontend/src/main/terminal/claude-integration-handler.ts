 ...
 * since DevFlow already restores terminals to their correct cwd/projectPath.
 *
...
export function resumeClaude(
  ...
  // This is more reliable than --resume with session IDs since DevFlow already restores
