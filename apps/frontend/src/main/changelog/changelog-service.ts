...
export class ChangelogService extends EventEmitter {
   ...
   * Checks DEBUG from devflow/.env and DEBUG from process.env
   */
  ...
  /**
   * Debug logging - only logs when DEBUG=true in devflow/.env or DEBUG is set
   */
  ...
  /**
   * Get the devflow source path (detects automatically if not configured)
   */
  ...
  /**
   * Load environment variables from devflow .env file
   */
