...
export function registerEnvHandlers(
  ...
  const generateEnvContent = (
    ...
    const content = `# DevFlow Framework Environment Variables
...
# If not set, DevFlow will auto-detect main/master, or fall back to current branch
...
${existingVars['GRAPHITI_DB_PATH'] ? `GRAPHITI_DB_PATH=${existingVars['GRAPHITI_DB_PATH']}` : '# GRAPHITI_DB_PATH=~/.devflow/memories'}
`;
