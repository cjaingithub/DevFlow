...
This directory contains the refactored context-related IPC handlers for the DevFlow UI application. The handlers manage project context, memory systems (both file-based and Graphiti/LadybugDB), and project index operations.
...
test('buildMemoryStatus returns correct status', () => {
  const status = buildMemoryStatus('/path/to/project', 'devflow');
...
- [Project Memory System](../../../../devflow/memory.py)
- [Graphiti Memory Integration](../../../../devflow/graphiti_memory.py)
