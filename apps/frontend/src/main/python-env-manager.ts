...
/**
 * Manages the Python environment for the devflow backend.
 *
 * For packaged apps:
...
export class PythonEnvManager extends EventEmitter {
  ...
  private async checkDepsInstalled(): Promise<boolean> {
    ...
    try {
      ...
      // See: https://github.com/AndyMik90/devflow/issues/359
      //
...
`;
   ...
   *
   * @see https://github.com/AndyMik90/devflow/issues/176
   */
