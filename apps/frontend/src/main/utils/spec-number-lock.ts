...
export class SpecNumberLock {
  ...
  constructor(projectDir: string) {
    ...
    this.lockDir = path.join(projectDir, '.devflow', '.locks');
  ...
  getNextSpecNumber(autoBuildPath?: string): number {
    ...
    const specsBase = autoBuildPath || '.devflow';
    ...
    const worktreesDir = path.join(this.projectDir, '.devflow', 'worktrees', 'tasks');
