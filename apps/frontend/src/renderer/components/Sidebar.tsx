...
export type SidebarView = 'kanban' | 'terminals' | 'roadmap' | 'context' | 'ideation' | 'flowchart-importer' | 'reference-generator' | 'github-issues' | 'gitlab-issues' | 'github-prs' | 'gitlab-merge-requests' | 'changelog' | 'insights' | 'worktrees' | 'agent-tools';
...
const baseNavItems: NavItem[] = [
  ...
  { id: 'flowchart-importer', labelKey: 'navigation:items.flowchartImporter', icon: Workflow, shortcut: 'F' },
  { id: 'reference-generator', labelKey: 'navigation:items.referenceGenerator', icon: Layers, shortcut: 'E' },
    ...
    <TooltipProvider>
      <div className="flex h-full w-64 flex-col bg-sidebar border-r border-border">
        ...
        <div className="electron-drag flex h-14 items-center px-4 pt-6">
          <span className="electron-no-drag text-lg font-bold text-primary">DevFlow</span>
        </div>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  variant="ghost"
                  size="icon"
                  onClick={() => window.open('https://github.com/AndyMik90/devflow/issues', '_blank')}
