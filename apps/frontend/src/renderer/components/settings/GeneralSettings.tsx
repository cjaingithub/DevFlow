          ...
          <div className="space-y-6">
            <div className="space-y-3">
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="devflow">{t('general.agentFrameworkdevflow')}</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div className="space-y-3">
  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        <div className="space-y-3">
          <Label htmlFor="autoBuildPath" className="text-sm font-medium text-foreground">{t('general.devflowPath')}</Label>
          <p className="text-sm text-muted-foreground">{t('general.devflowPathDescription')}</p>
          <Input
            id="autoBuildPath"
            placeholder={t('general.devflowPathPlaceholder')}
            className="w-full max-w-lg"
