              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 space-y-3">
                  ...
                  <p className="text-sm text-muted-foreground">
                    {t('claudeCode.info.description', "Claude Code is Anthropic's official CLI that powers DevFlow's AI features. It provides secure authentication and direct access to Claude models.")}
                  </p>
                </div>
              </div>
            </CardContent>
