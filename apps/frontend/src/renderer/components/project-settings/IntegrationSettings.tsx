            ...
            {envConfig.githubEnabled && (
              <>
                ...
                <div className="space-y-2">
                  ...
                  {settings.mainBranch && (
                    <p className="text-xs text-muted-foreground">
                      Tasks will be created on branches like <code className="px-1 bg-muted rounded">devflow/task-name</code> from <code className="px-1 bg-muted rounded">{settings.mainBranch}</code>
                    </p>
                  )}
                </div>
              </>
