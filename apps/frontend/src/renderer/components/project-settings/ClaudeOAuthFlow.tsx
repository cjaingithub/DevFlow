              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 space-y-3">
                  ...
                  <p className="text-sm text-muted-foreground">
                    DevFlow requires Claude AI authentication for AI-powered features like
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="text-xs text-muted-foreground space-y-1">
                    ...
                    <ol className="list-decimal list-inside space-y-1 ml-2">
                      ...
                      <li>DevFlow will automatically detect and save it</li>
                    </ol>
                  </div>
                </div>
              </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2 mt-3 text-xs text-success/70">
                  ...
                  <span>You can now use all DevFlow AI features</span>
                </div>
              </div>
            </div>
          </CardContent>
