...
// GitLab integration
  ...
  // DevFlow source environment configuration
  ...
  // Flowchart XML import operations
  FLOWCHART_PARSE_XML: 'flowchart:parseXml',
  FLOWCHART_PARSE_CONTENT: 'flowchart:parseContent',
  FLOWCHART_LOAD_REFERENCE: 'flowchart:loadReference',
  FLOWCHART_LIST_REFERENCES: 'flowchart:listReferences',
  FLOWCHART_GET_REFERENCE: 'flowchart:getReference',
  FLOWCHART_DELETE_REFERENCE: 'flowchart:deleteReference',
  FLOWCHART_GENERATE: 'flowchart:generate',
  FLOWCHART_GENERATE_FROM_REF: 'flowchart:generateFromRef',
  FLOWCHART_SELECT_FILE: 'flowchart:selectFile',
  FLOWCHART_SAVE_FILES: 'flowchart:saveFiles',

  // Flowchart events (main -> renderer)
  FLOWCHART_PARSE_PROGRESS: 'flowchart:parseProgress',
  FLOWCHART_GENERATION_PROGRESS: 'flowchart:generationProgress',

  // Reference Generator operations
  ...
  REFERENCE_SELECT_DIR: 'reference:selectDir',
  REFERENCE_SELECT_FILE: 'reference:selectFile',
  REFERENCE_SAVE_FILES: 'reference:saveFiles',
  REFERENCE_APPLY_TO_PROJECT: 'reference:applyToProject',

  // Reference Generator events (main -> renderer)
  REFERENCE_LOAD_PROGRESS: 'reference:loadProgress',
  REFERENCE_GENERATION_PROGRESS: 'reference:generationProgress',
  REFERENCE_GENERATION_COMPLETE: 'reference:generationComplete',
  REFERENCE_GENERATION_ERROR: 'reference:generationError'
} as const;
