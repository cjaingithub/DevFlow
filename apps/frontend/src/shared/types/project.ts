...
export interface GraphitiProviderConfig {
  ...
  dbPath?: string;    // Database storage path (default: ~/.devflow/memories)
}
 ...
 * Stored in .devflow/.env as AGENT_MCP_<agent>_ADD and AGENT_MCP_<agent>_REMOVE
 */
...
// DevFlow Initialization Types
export interface AutoBuildVersionInfo {
  isInitialized: boolean;
  updateAvailable: boolean; // Always false - .devflow only contains data, no code to update
}
